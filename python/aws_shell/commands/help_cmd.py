...
SERVICE_HELP = {
    ...
    "python": {
        ...
        "commands": {
            ...
            ">>> list_instances()": "Helper: returns all EC2 instances as raw data",
            ">>> list_buckets()": "Helper: returns all S3 buckets as raw data",
            ">>> list_roles()": "Helper: returns all IAM roles as raw data",
            ">>> find(data, kw)": "Utility: fuzzy search through JSON data",
        },
    },
    "general": {
